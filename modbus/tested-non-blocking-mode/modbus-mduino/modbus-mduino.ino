...
void loop() {
  ...
  if (master.isWaitingResponse()) {
    Serial.println("isWaitingResponse"); //debug
    ModbusResponse response = master.available();

    if (response) {
      Serial.println("Got response"); //debug
  ...
  else Serial.println("notWaitingResponse"); //debug
